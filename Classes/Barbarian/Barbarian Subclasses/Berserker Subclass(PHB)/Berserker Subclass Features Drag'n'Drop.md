...
| 3rd | +2 | Path of the Berserker, Frenzy, Primal Knowledge (optional)  | 3 | +2 |
...
| 10th | +4 | Intimidating Presence, Primal Knowledge (optional) | 4 | +3 |
...
```
### Mindless Rage
Beginning at 6th level, you can't be charmed or frightened while raging. lf you are charmed or frightened when you enter your rage, the effect is suspended for the duration of the rage.
```
```
