...
| 3rd | +2 | Eldritch Knight, Spellcasting, Weapon Bond |2|3|2|-|-|-|
| 4th | +2 | Ability Score Improvement, Martial Versatility (optional) |2|4|3|-|-|-|
| 5th | +3 | Extra Attack |2|4|3|-|-|-|
| 6th | +3 | Ability Score Improvement, Martial Versatility (optional) |2|4|3|-|-|-|
| 7th | +3 | War Magic |2|5|4|2|-|-|
| 8th | +3 | Ability Score Improvement, Martial Versatility (optional) |2|6|4|2|-|-|
| 9th | +4 | Indomitable (one use) |2|6|4|2|-|-|
| 10th | +4 | Eldritch Strike |3|7|4|3|-|-|
| 11th | +4 | Extra Attack (2) |3|8|4|3|-|-|
| 12th | +4 | Ability Score Improvement, Martial Versatility (optional) |3|8|4|3|-|-|
| 13th | +5 | Indomitable (two uses) |3|9|4|3|2|-|
| 14th | +5 | Ability Score Improvement, Martial Versatility (optional) |3|10|4|3|2|-|
| 15th | +5 | Arcane Charge |3|10|4|3|2|-|
| 16th | +5 | Ability Score Improvement, Martial Versatility (optional) |3|11|4|3|3|-|
| 17th | +6 | Action Surge (two uses), Indomitable<br>(three uses) |3|11|4|3|3|-|
...
with a careful study of magic. Eldritch Knights use magical techniques similar to
those practiced by wizards. They focus their study on two of the eight schools of
magic: abjuration and evocation. Abjuration spells grant an Eldritch Knight
additional protection in battle, and evocation spells deal damage to many foes at
once, extending the fighter's reach in combat. These knights learn a comparatively 
...
abjuration or evocation spell of your choice, and must be of a level for which you
have spell slots. For instance, when you reach 7th level in this class, you can learn
...
know with another spell of your choice from the wizard spell list. The new spell must
be of a level for which you have spell slots, and it must be an abjuration or
evocation spell, unless you're replacing the spell you gained at 3rd, 8th, 14th, or
20th level from any school of magic.

#### Spellcasting Ability
Intelligence is your spellcasting ability for your wizard spells, since you learn
your spells through study and memorization. You use your Intelligence whenever a
...
creature has disadvantage on the next saving throw it makes against a spell you cast
...
### Improved War Magic
Starting at 18th level, when you use your action to cast a spell, you can make one
weapon attack as a bonus action.
```
